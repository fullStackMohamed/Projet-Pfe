...
//     const userLinks = auth.user.role === 'user' ? [
//         { name: translations.dashboard, href: route('dashboard'), active: route().current('dashboard') },
//         { name: translations.my_projects, href: route('myProjects'), active: route().current('myProjects') },
//         { name: translations.my_tasks, href: route('myTasks'), active: route().current('myTasks') }
//     ] : [
//         { name: translations.dashboard, href: route('dashboard2'), active: route().current('dashboard2') },
//         { name: translations.projects, href: route('project.index'), active: route().current('project.index') },
//         { name: translations.all_tasks, href: route('task.index'), active: route().current('task.index') },
//         { name: translations.users, href: route('user.index'), active: route().current('user.index') }
//     ];
//     console.log(translations)
//     console.log(translations.dashboard)
//     return (
