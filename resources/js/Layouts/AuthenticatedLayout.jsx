...
//                                 <ApplicationLogo className="block h-14 w-auto fill-current text-indigo-600 dark:text-indigo-400 group-hover:text-indigo-700 dark:group-hover:text-indigo-300 transition" />
//                                 <span className="ml-2 text-xl font-semibold text-gray-800 dark:text-gray-200 group-hover:text-indigo-700 dark:group-hover:text-indigo-300 transition">TaskManager</span>
//                             </Link>
//                         </div>
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 items-center justify-between">
                        ...
                        <div className="flex shrink-0 items-center">
                            <Link href="/" className="flex items-center group">
                                <ApplicationLogo className="block h-14 w-auto fill-current text-indigo-600 dark:text-indigo-400 group-hover:text-indigo-700 dark:group-hover:text-indigo-300 transition" />
                                <span className="ml-2 text-xl font-semibold text-gray-800 dark:text-gray-200 group-hover:text-indigo-700 dark:group-hover:text-indigo-300 transition">{/*TaskManager*/} {trans_layout.project_name} </span>
                            </Link>
                        </div>
                        ...
                        <div className="space-y-1 px-2 pb-3 pt-2">
                            ...
                            <div className="mt-3 px-3 py-2">
                                <div className="text-sm font-medium text-gray-600 dark:text-gray-300 mb-2">
                                    {trans_layout.language || "Language"}:
                                </div>
                                <LanguageSwitcher />
                            </div>
                        </div>
