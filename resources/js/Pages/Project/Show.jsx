           ...
           <AuthenticatedLayout
              ...
              <div className="p-6 text-gray-900 dark:text-100">
                <div className="grid gap-1 grid-cols-2 mt-2">
                    <div>
                        <div>
                            <label className="font-bold text-lg dark:text-gray-200">Project ID</label>
                            <p className="mt-1 dark:text-white">{project.id}</p>    
                        </div>       

                        <div className="mt-4">
                            <label className="font-bold text-lg dark:text-gray-200">Project Name</label>
                            <p className="mt-1 dark:text-white">{project.name}</p>    
                        </div> 

                        <div className="mt-4">
                            <label className="font-bold text-lg dark:text-gray-200">Project Status</label>
                ...
                <div className="mt-4">
                    <label className="font-bold text-lg dark:text-gray-200">Project Description</label>
